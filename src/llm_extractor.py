...
输出JSON数组，每个元素：
{{"seq": "序号", "project_code": "项目编码", "project_name": "项目名称", "project_description": "项目特征", "unit": "计量单位", "quantity": "工程量", "unit_price": "综合单价", "total_price": "合价", "labor_cost": "其中人工费", "machinery_cost": "其中机械费", "provisional_estimate": "暂估价", "remark": "备注"}}

注意：
- project_code 来自“项目编码”列，项目编码类似"010902001001"
